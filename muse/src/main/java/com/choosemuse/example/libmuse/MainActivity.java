...
public class MainActivity extends Activity implements OnClickListener {
     ...
     * getValue methods.
     */
    public void getEegChannelValues(double[] buffer, MuseDataPacket p) {
    ...
    private void initUI() {
        ...
        //Button randLights = (Button) findViewById(R.id.buttonRand);
        //randLights.setOnClickListener(this);
    ...
    public double[] getGammaValues() {
        System.out.println("getGammaValues"+gammaBuffer[0]);
        return gammaBuffer;
    }
